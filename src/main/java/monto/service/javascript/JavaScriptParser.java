...
public class JavaScriptParser extends MontoService {
  ...
  private monto.service.javascript.antlr.ECMAScriptParser parser =
      new monto.service.javascript.antlr.ECMAScriptParser(tokens);
  ...
  private static class Converter implements ParseTreeListener {
    ...
    public void enterEveryRule(ParserRuleContext context) {
      if (context.getChildCount() > 0) {
        String name =
            monto.service.javascript.antlr.ECMAScriptParser.ruleNames[context.getRuleIndex()];
